...
import (
	...
	"github.com/jacobd39/twittor/middlew"
	"github.com/jacobd39/twittor/routers"
	"github.com/rs/cors"
)

//Manejadores setean mi puerto, el Handler y pongo a escuchar al servidor
func Manejadores() {
	...
	router.HandleFunc("/leoTweetsRelacion", middlew.ChequeoBD(middlew.ValidoJWT(routers.LeoTweetsRelacion))).Methods("GET")
